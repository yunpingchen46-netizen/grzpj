...
export const CAPABILITIES: Capability[] = [
  {
    ...
    preview: { src: "/assets/capabilities/previews/preview-aigc.png", alt: "AIGC 创作", placeholder: false },
    items: [],
    relatedProjects: [
    ...
    caseStudy: {
      ...
      sections: [
        ...
        { id: "aigc-os-media", title: "线上体验截图与视频", type: "media", items: [
          { src: "/assets/capabilities/aigc/portfolio/portfolio-home.png", alt: "线上体验截图 01", placeholder: false },
          { src: "/assets/capabilities/aigc/portfolio/portfolio-projects.png", alt: "线上体验截图 02", placeholder: false },
          { src: "/assets/capabilities/aigc/portfolio/portfolio-ai-archive.png", alt: "线上体验截图 03", placeholder: false },
          { src: "/assets/capabilities/aigc/portfolio/portfolio-capabilities.jpg", alt: "线上体验截图 04", placeholder: false },
          { src: "/api/media?pathname=portfolio/aigc/demo-online.mp4", alt: "线上演示视频", placeholder: false },
          { src: "/api/media?pathname=portfolio/aigc/demo-offline-title.mp4", alt: "线下标题选择网站", placeholder: false },
        ]},
  ...
  },
  {
    ...
    preview: { src: "/assets/capabilities/previews/preview-interaction.png", alt: "交互体验设计", placeholder: false },
    items: [
    ...
    caseStudy: {
      ...
      team: "四人团队项目",
      myRole: null,
      coverSrc: "/assets/capabilities/xinsheng-journey/interaction/interaction-cover.jpg",
      coverAlt: "心生奇旅主视觉",
      sections: [
        ...
        { id: "xs-media", title: "项目素材", type: "media", items: [
          { src: "/assets/capabilities/xinsheng-journey/interaction/interaction-cover.jpg", alt: "项目主视觉", placeholder: false },
          { src: "/assets/capabilities/xinsheng-journey/interaction/interaction-world.jpg", alt: "世界观与角色", placeholder: false },
          { src: "/assets/capabilities/xinsheng-journey/interaction/interaction-levels.jpg", alt: "六关总览", placeholder: false },
          { src: "/assets/capabilities/xinsheng-journey/interaction/interaction-stage-03.png", alt: "第三关塔防流程", placeholder: false },
          { src: "/assets/capabilities/xinsheng-journey/interaction/interaction-stage-05.png", alt: "第五关卡牌流程", placeholder: false },
        ]},
      ],
    },
  },
  {
    ...
    tools: ["Unity"],
    preview: { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-cover.png", alt: "南粤古驿道主视觉", placeholder: false },
    items: [
      {
        id: "vr-nanyue",
        title: "南粤古驿道",
        ...
        placeholder: true,
        extraImages: [
          { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-cover.png", alt: "项目主视觉", placeholder: false },
          { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-scene-01.png", alt: "场景全景", placeholder: false },
          { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-scene-02.png", alt: "建筑与环境细节", placeholder: false },
          { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-interaction-01.png", alt: "物品交互展示", placeholder: false },
          { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-modeling-01.png", alt: "建模过程", placeholder: false },
          { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-extra-01.png", alt: "场景细节 01", placeholder: false },
          { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-extra-02.png", alt: "场景细节 02", placeholder: false },
          { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-extra-03.png", alt: "场景细节 03", placeholder: false },
          { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-extra-04.png", alt: "场景细节 04", placeholder: false },
          { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-extra-05.png", alt: "场景细节 05", placeholder: false },
          { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-extra-06.png", alt: "场景细节 06", placeholder: false },
          { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-extra-07.png", alt: "场景细节 07", placeholder: false },
          { src: "/assets/capabilities/vr-design/nanyue-ancient-road/nanyue-extra-08.png", alt: "场景细节 08", placeholder: false },
        ],
      },
    ],
  },
  {
    ...
    tools: ["After Effects"],
    preview: { src: "/assets/capabilities/previews/preview-motion.png", alt: "动效设计", placeholder: false },
    items: [
      {
        ...
        src: "/api/media?pathname=portfolio/motion/zero-and-one.mov",
      ...
      },
      {
        ...
        tools: ["After Effects"], mediaType: "video",
        src: "/api/media?pathname=portfolio/motion/regeneration-plan.mp4",
      ...
      },
      {
        ...
        tools: ["After Effects"], mediaType: "video",
        src: "/api/media?pathname=portfolio/motion/ming-floor-lamp.mp4",
  ...
  },
  {
    ...
    tools: ["Blender"],
    preview: { src: "/assets/capabilities/modeling-rendering/portal-01.png", alt: "传送门渲染", placeholder: false },
    items: [
      {
        id: "mdl-portal",
        title: "传送门",
        ...
        tools: ["Blender"],
        mediaType: "image",
        src: "/assets/capabilities/modeling-rendering/portal-01.png",
        alt: "传送门渲染",
        placeholder: false,
        extraImages: [
          { src: "/assets/capabilities/modeling-rendering/portal-02.png", alt: "传送门 02", placeholder: false },
          { src: "/assets/capabilities/modeling-rendering/portal-03.png", alt: "传送门 03", placeholder: false },
          { src: "/assets/capabilities/modeling-rendering/portal-04.png", alt: "传送门 04", placeholder: false },
          { src: "/assets/capabilities/modeling-rendering/portal-05.png", alt: "传送门 05", placeholder: false },
        ],
      },
      {
        id: "mdl-planet",
        ...
        tools: ["Blender"],
        mediaType: "image",
        src: "/assets/capabilities/modeling-rendering/planet-01.png",
        alt: "星球渲染",
        placeholder: false,
        extraImages: [
          { src: "/assets/capabilities/modeling-rendering/planet-02.png", alt: "星球 02", placeholder: false },
          { src: "/assets/capabilities/modeling-rendering/planet-03.png", alt: "星球 03", placeholder: false },
          { src: "/assets/capabilities/modeling-rendering/planet-04.png", alt: "星球 04", placeholder: false },
        ],
      },
      {
        id: "mdl-earth",
        ...
        tools: ["Blender"],
        mediaType: "image",
        src: "/assets/capabilities/modeling-rendering/earth-01.png",
        alt: "类地行星渲染",
        placeholder: false,
        extraImages: [
          { src: "/assets/capabilities/modeling-rendering/earth-02.png", alt: "类地行星 02", placeholder: false },
          { src: "/assets/capabilities/modeling-rendering/earth-03.png", alt: "类地行星 03", placeholder: false },
        ],
      },
      {
        id: "mdl-web",
        ...
        tools: ["Blender"],
        mediaType: "image",
        src: "/assets/capabilities/modeling-rendering/web-01.png",
        alt: "蜘蛛网渲染",
        placeholder: false,
        extraImages: [
          { src: "/assets/capabilities/modeling-rendering/web-02.png", alt: "蜘蛛网 02", placeholder: false },
          { src: "/assets/capabilities/modeling-rendering/web-03.png", alt: "蜘蛛网 03", placeholder: false },
          { src: "/assets/capabilities/modeling-rendering/web-04.png", alt: "蜘蛛网 04", placeholder: false },
          { src: "/assets/capabilities/modeling-rendering/web-05.png", alt: "蜘蛛网 05", placeholder: false },
          { src: "/assets/capabilities/modeling-rendering/web-06.png", alt: "蜘蛛网 06", placeholder: false },
          { src: "/assets/capabilities/modeling-rendering/web-07.png", alt: "蜘蛛网 07", placeholder: false },
        ],
      },
      {
        id: "mdl-donut",
        ...
        tools: ["Blender"],
        mediaType: "video",
        src: "/api/media?pathname=portfolio/modeling-rendering/donut.mp4",
        alt: "甜甜圈渲染动画",
        placeholder: false,
      },
      {
        ...
        tools: ["Blender"],
        mediaType: "video",
        src: "/api/media?pathname=portfolio/modeling-rendering/render-01.mov",
        alt: "渲染作品 01",
        placeholder: false,
      },
      {
        ...
        tools: ["Blender"],
        mediaType: "video",
        src: "/api/media?pathname=portfolio/modeling-rendering/render-02.mov",
        alt: "渲染作品 02",
        placeholder: false,
      },
      {
        ...
        tools: ["Blender"],
        mediaType: "video",
        src: "/api/media?pathname=portfolio/modeling-rendering/render-03.mov",
        alt: "渲染作品 03",
        placeholder: false,
      },
      {
        ...
        tools: ["Blender"],
        mediaType: "video",
        src: "/api/media?pathname=portfolio/modeling-rendering/render-04.mov",
        alt: "渲染作品 04",
        placeholder: false,
      },
      {
        ...
        tools: ["Blender"],
        mediaType: "video",
        src: "/api/media?pathname=portfolio/modeling-rendering/snow-mountain.mov",
        alt: "雪山渲染",
        placeholder: false,
      },
    ],
  },
  {
    ...
    tools: [],
    preview: { src: "/assets/capabilities/video/we-need-to-talk-storyboard-01.jpg", alt: "《We Need to Talk...》分镜首帧", placeholder: false },
    items: [
      {
        ...
        mediaType: "video",
        src: "/api/media?pathname=portfolio/video/we-need-to-talk.mp4",
        alt: "《We Need to Talk...》实拍短片",
        placeholder: false,
        extraImages: [
          { src: "/assets/capabilities/video/we-need-to-talk-storyboard-01.jpg", alt: "分镜：开场人物进入空间", placeholder: false },
          { src: "/assets/capabilities/video/we-need-to-talk-storyboard-02.jpg", alt: "分镜：事件发生", placeholder: false },
          { src: "/assets/capabilities/video/we-need-to-talk-storyboard-03.jpg", alt: "分镜：追逐开始", placeholder: false },
          { src: "/assets/capabilities/video/we-need-to-talk-storyboard-04.jpg", alt: "分镜：追逐升级", placeholder: false },
          { src: "/assets/capabilities/video/we-need-to-talk-storyboard-05.jpg", alt: "分镜：高潮部分", placeholder: false },
          { src: "/assets/capabilities/video/we-need-to-talk-storyboard-06.jpg", alt: "分镜：结尾反转", placeholder: false },
        ],
      },
      {
        id: "vid-jenga",
        ...
        myRole: ["分镜设计"],
        mediaType: "video",
        src: "/api/media?pathname=portfolio/video/jenga.mp4",
        alt: "《JENGA》概念影像",
        placeholder: false,
        metaphorGroups: [
        ...
        extraImages: [
          { src: "/assets/capabilities/video/jenga-concept-01.jpg", alt: "JENGA 概念图 01", placeholder: false },
          { src: "/assets/capabilities/video/jenga-concept-02.jpg", alt: "JENGA 概念图 02", placeholder: false },
          { src: "/assets/capabilities/video/jenga-concept-03.jpg", alt: "JENGA 概念图 03", placeholder: false },
          { src: "/assets/capabilities/video/jenga-concept-04.jpg", alt: "JENGA 概念图 04", placeholder: false },
          { src: "/assets/capabilities/video/jenga-concept-05.jpg", alt: "JENGA 概念图 05", placeholder: false },
          { src: "/assets/capabilities/video/jenga-concept-06.jpg", alt: "JENGA 概念图 06", placeholder: false },
        ],
      },
    ],
  },
  {
    ...
    tools: ["Figma"],
    preview: { src: "/assets/capabilities/previews/preview-ui.png", alt: "界面设计", placeholder: false },
    items: [
      {
        id: "ui-huolai",
        title: "货来",
        ...
        alt: "《货来》主视觉",
        placeholder: false,
        src: "/assets/capabilities/ui/huolai/huolai-board.jpg",
        extraImages: [
          { src: "/assets/capabilities/ui/huolai/huolai-tracking.jpg", alt: "查件列表与物流详情", placeholder: false, aspectRatio: "9/19.5" },
          { src: "/assets/capabilities/ui/huolai/huolai-map.jpg", alt: "派送租车与路线", placeholder: false, aspectRatio: "9/19.5" },
          { src: "/assets/capabilities/ui/huolai/huolai-send.jpg", alt: "寄件入口与信息填写", placeholder: false, aspectRatio: "9/19.5" },
          { src: "/assets/capabilities/ui/huolai/huolai-delivery.jpg", alt: "派送订单", placeholder: false, aspectRatio: "9/19.5" },
          { src: "/assets/capabilities/ui/huolai/huolai-profile.jpg", alt: "个人中心", placeholder: false, aspectRatio: "9/19.5" },
          { src: "/assets/capabilities/ui/huolai/huolai-framework.jpg", alt: "数据分析", placeholder: false },
        ],
      },
      {
        id: "ui-stu-academic",
        ...
        placeholder: false,
        src: "/assets/capabilities/ui/stu-academic/stu-poster.png",
        extraImages: [
          { src: "/assets/capabilities/ui/stu-academic/stu-home.png", alt: "首页", placeholder: false, aspectRatio: "9/19.5" },
          { src: "/assets/capabilities/ui/stu-academic/stu-schedule.png", alt: "我的课表", placeholder: false, aspectRatio: "9/19.5" },
          { src: "/assets/capabilities/ui/stu-academic/stu-notice.png", alt: "通知公告", placeholder: false, aspectRatio: "9/19.5" },
          { src: "/assets/capabilities/ui/stu-academic/stu-records.png", alt: "学生记录中心", placeholder: false, aspectRatio: "9/19.5" },
          { src: "/assets/capabilities/ui/stu-academic/stu-services.png", alt: "登录页面", placeholder: false, aspectRatio: "9/19.5" },
          { src: "/assets/capabilities/ui/stu-academic/stu-profile.png", alt: "个人中心与设置", placeholder: false, aspectRatio: "9/19.5" },
        ],
      },
    ],
  },
  {
    ...
    tools: ["Figma"],
    preview: { src: "/assets/capabilities/previews/preview-research.png", alt: "用户研究", placeholder: false },
    items: [
    ...
    caseStudy: {
      ...
      team: "四人团队项目",
      myRole: null,
      coverSrc: "/assets/capabilities/xinsheng-journey/research/心生奇旅 (1).png",
      coverAlt: "研究流程",
      sections: [
        ...
        { id: "rs-competitor", title: "竞品分析", type: "text", content: "现有性教育产品主要包括：答题式科普、图文解释、线上书籍、线下讲座、社区内容、咨询平台。主要问题：形式较单一、互动性不足、内容表达较生硬、家庭参与弱、部分服务受地域限制、难以适配不同年龄和学习阶段。", items: [
          { src: "/assets/capabilities/xinsheng-journey/research/research-competitor-map.jpg", alt: "竞品坐标图", placeholder: true },
          { src: "/assets/capabilities/xinsheng-journey/research/research-radar.jpg", alt: "竞品雷达分析", placeholder: true },
        ]},
        ...
        { id: "rs-media", title: "研究素材", type: "media", items: [
          { src: "/assets/capabilities/xinsheng-journey/research/1234.png", alt: "研究图表 01", placeholder: false },
          { src: "/assets/capabilities/xinsheng-journey/research/daec6138920e411ae607b8cf476e5cc.jpg", alt: "研究图表 02", placeholder: false },
          { src: "/assets/capabilities/xinsheng-journey/research/image.png", alt: "研究图表 03", placeholder: false },
          { src: "/assets/capabilities/xinsheng-journey/research/image (1).png", alt: "研究图表 04", placeholder: false },
          { src: "/assets/capabilities/xinsheng-journey/research/image (2).png", alt: "研究图表 05", placeholder: false },
          { src: "/assets/capabilities/xinsheng-journey/research/心生奇旅 (1).png", alt: "心生奇旅 01", placeholder: false },
          { src: "/assets/capabilities/xinsheng-journey/research/竞品2.png", alt: "竞品分析", placeholder: false },
        ]},
      ],
    },
  },
