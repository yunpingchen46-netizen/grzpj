    ...
    caseStudy: {
      ...
      sections: [
        ...
        { id: "aigc-os-media", title: "线上体验截图与视频", type: "media", items: [
          ...
          { src: "/assets/capabilities/aigc/portfolio/线上演示视频.mp4", alt: "线上演示视频", placeholder: false },
          { src: "/assets/capabilities/aigc/portfolio/线下标题选择网站.mp4", alt: "线下标题选择网站", placeholder: false },
        ]},
    ...
    items: [
      {
        ...
        src: "/assets/capabilities/motion/zero-and-one.mov",
      ...
      },
      {
        ...
        tools: ["After Effects"], mediaType: "video",
        src: "/assets/capabilities/motion/regeneration-plan.mp4",
      ...
      },
      {
        ...
        tools: ["After Effects"], mediaType: "video",
        src: "/assets/capabilities/motion/ming-floor-lamp.mp4",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        tools: ["Blender"],
        mediaType: "video",
        src: "/assets/capabilities/modeling-rendering/甜甜圈10001-0300.mp4",
        alt: "甜甜圈渲染动画",
        placeholder: false,
      },
      {
        ...
        tools: ["Blender"],
        mediaType: "video",
        src: "/assets/capabilities/modeling-rendering/7月2日.mov",
        alt: "渲染作品 01",
        placeholder: false,
      },
      {
        ...
        tools: ["Blender"],
        mediaType: "video",
        src: "/assets/capabilities/modeling-rendering/7月2日(1).mov",
        alt: "渲染作品 02",
        placeholder: false,
      },
      {
        ...
        tools: ["Blender"],
        mediaType: "video",
        src: "/assets/capabilities/modeling-rendering/7月2日(2).mov",
        alt: "渲染作品 03",
        placeholder: false,
      },
      {
        ...
        tools: ["Blender"],
        mediaType: "video",
        src: "/assets/capabilities/modeling-rendering/7月2日(3).mov",
        alt: "渲染作品 04",
        placeholder: false,
      },
      {
        ...
        tools: ["Blender"],
        mediaType: "video",
        src: "/assets/capabilities/modeling-rendering/雪山.mov",
        alt: "雪山渲染",
        placeholder: false,
      },
    ],
    ...
    items: [
      {
        ...
        mediaType: "video",
        src: "/assets/capabilities/video/we-need-to-talk.mp4",
      ...
      },
      {
        ...
        myRole: ["分镜设计"],
        mediaType: "video",
        src: "/assets/capabilities/video/jenga.mp4",
        alt: "《JENGA》概念影像",
        placeholder: false,
        metaphorGroups: [
